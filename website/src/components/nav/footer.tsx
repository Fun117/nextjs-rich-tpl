...
function Footer() {
  ...
  return (
    <footer className="w-full mx-auto overflow-hidden border-t border-t-neutral-200 dark:border-t-neutral-800 text-neutral-500">
          ...
          <div className="grid gap-8 grid-cols-[repeat(auto-fill,minmax(140px,1fr))] lg:flex flex-wrap justify-between">
            ...
            {config.themeConfig.footer?.items?.map((group, idx) => (
              <div key={idx} className="flex flex-col">
                <h4 className="text-sm font-semibold mb-4 text-neutral-800 dark:text-neutral-200">
